...
INSERT OR IGNORE INTO pr_settings (key, value) VALUES ('max_diff', '3000'), ('stale_author_days', '3'), ('stale_days', '7'), ('model', 'claude-sonnet-5'), ('max_reviews', '1'), ('session_model', 'claude-sonnet-5');
